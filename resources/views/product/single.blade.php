              ...
              <div class="zoomWrapper">
                <div id="img-1" class="zoomWrapper single-zoom">
                  <a href="#">
                    <img
                      id="zoom1"
                      src="/assets/img/product/lg-product-1.jpg"
                      data-zoom-image="/assets/img/product/lg-product-1.jpg"
                      alt="big-1"
                    />
                  </a>
                </div>
                  ...
                  >
                    <li>
                      <a
                        ...
                        data-update=""
                        data-image="/assets/img/product/lg-product-1.jpg"
                        data-zoom-image="/assets/img/product/lg-product-1.jpg"
                    ...
                    <li class="">
                      <a
                        ...
                        data-image="/assets/img/product/lg-product-2.jpg"
                        data-zoom-image="/assets/img/product/lg-product-2.jpg"
                    ...
                    <li class="">
                      <a
                        href="#"
                        class="elevatezoom-gallery"
                        data-image="/assets/img/product/lg-product-3.jpg"
                        data-zoom-image="/assets/img/product/lg-product-3.jpg"
                    ...
                    <li class="">
                      <a
                        href="#"
                        class="elevatezoom-gallery"
                        data-image="/assets/img/product/lg-product-4.jpg"
                        data-zoom-image="/assets/img/product/lg-product-4.jpg"
            ...
            <div class="quick-view-content">
              <div class="product-info">
                ...
                <p>
                  ...
                  and orange high waisted skater skirt bottom.
                </p>
                    ...
                    >
                      <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                            <p>
                              It’s both good and bad. If Nikon had achieved a
                              high-quality wide lens camera with a 1 inch
                              sensor, that would have been a very competitive
                              product. So in that sense, it’s good for us. But
                              actually, from the perspective of driving the 1
                              inch sensor market, we want to stimulate this
                              market and that means multiple manufacturers.
                            </p>
                            <ul>
            ...
            <div class="product_desc">
              <div class="product_desc_info">
                ...
                <h4>
                  <a class="product_name" href="single-product.html"
                    >Air Jordan XI Retro</a
                  >
                </h4>
                <div class="manufacturer">
                  <a href="single-product.html">Fashion Manufacturer</a>
                </div>
                <div class="price-box">
                  <span class="new-price">$225.00</span>
                  <span class="old-price">$250.00</span>
              ...
              <div class="add-actions">
                <ul class="add-actions-link">
                  ...
                  <li>
                    <a class="links-details" href="single-product.html"
